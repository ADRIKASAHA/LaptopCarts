...
const AddProduct = () => {
  ...
  const handleProduct = (event) => {
    ...
    fetch(" https://laptop-server-two.vercel.app/product", {
      method: "POST",
      headers: {
        ...
        <form onSubmit={handleProduct}>
          <div className="w-full py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding">
            <div className="mb-6">
              ...
              <select id="id">
                <option value="6384c3f40d1d334185528dd7" selected>
                  Dell
                </option>
                <option value="6384c4130d1d33418552d548">hp</option>
                <option value="6384c4730d1d33418553a5ef">Lenovo</option>
              </select>
            </div>
          </div>
